...
| Faz 8 (v2, başladı) | Banka ekstresi içe aktarma & mutabakat (MT940/CSV, otomatik eşleştirme) | ✅ |

**206 birim/entegrasyon testi yeşil** (`mvn test`). Ayrıca: `-Pperf test` performans bütçesi,
